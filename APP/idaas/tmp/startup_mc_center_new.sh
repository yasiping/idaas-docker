...
JVM_OPTS=" -XX:+UseConcMarkSweepGC -XX:+UseParNewGC -XX:ParallelGCThreads=5 -XX:SurvivorRatio=2 -Dlog4j2.formatMsgNoLookups=true"
...
help() {
  ...
  echo "-a : Modify the access address of the mc-center project, such as '-a https://192.168.60.1:18020'"
...
processLog() {
  ...
  touch /data/mc-center/log/process.log
